...
var BaseTable = /** @class */ (function () {
    ...
    BaseTable.prototype.sort = function (sortEvent) {
        this.sortBy = sortEvent.name;
        this.sortOrder = sortEvent.order;
        this.filter();
    };
    BaseTable.prototype.search = function (searchTerm) {
        this.searchTerm = searchTerm;
        this.pagingBar.navigateToPage(1);
        this.filter();
    };
    BaseTable.prototype.page = function (pagingEvent) {
        this.fromRow = pagingEvent.fromRow;
        this.currentPage = pagingEvent.page;
        this.pageSize = pagingEvent.pageSize;
        this.filter();
    };
    BaseTable.prototype.filter = function () {
    ...
    BaseTable.prototype.detectChanges = function () {
        var _this = this;
        setTimeout(function () {
            if (_this._cdr !== null &&
    ...
    ], BaseTable.prototype, "pagingBar", void 0);
    return BaseTable;
}());
